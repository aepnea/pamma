...
class BeneficiariesControllerTest < ActionController::TestCase
  ...
  test "should create beneficiary" do
    assert_difference('Beneficiary.count') do
      post :create, beneficiary: { address: @beneficiary.address, age: @beneficiary.age, name: @beneficiary.name, rut: @beneficiary.rut, user_id: @beneficiary.user_id }
    end
  ...
  test "should update beneficiary" do
    patch :update, id: @beneficiary, beneficiary: { address: @beneficiary.address, age: @beneficiary.age, name: @beneficiary.name, rut: @beneficiary.rut, user_id: @beneficiary.user_id }
    assert_redirected_to beneficiary_path(assigns(:beneficiary))
  end
