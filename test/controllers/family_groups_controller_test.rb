...
class FamilyGroupsControllerTest < ActionController::TestCase
  ...
  test "should create family_group" do
    assert_difference('FamilyGroup.count') do
      post :create, family_group: { activity: @family_group.activity, age: @family_group.age, name: @family_group.name, relationship_type_id: @family_group.relationship_type_id, scholarship_type_id: @family_group.scholarship_type_id, user_id: @family_group.user_id }
    end
  ...
  test "should update family_group" do
    patch :update, id: @family_group, family_group: { activity: @family_group.activity, age: @family_group.age, name: @family_group.name, relationship_type_id: @family_group.relationship_type_id, scholarship_type_id: @family_group.scholarship_type_id, user_id: @family_group.user_id }
    assert_redirected_to family_group_path(assigns(:family_group))
  end
