...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { asociative_user_id: @milestone.asociative_user_id, date_begin: @milestone.date_begin, date_end: @milestone.date_end, description: @milestone.description, name: @milestone.name, user_id: @milestone.user_id }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { asociative_user_id: @milestone.asociative_user_id, date_begin: @milestone.date_begin, date_end: @milestone.date_end, description: @milestone.description, name: @milestone.name, user_id: @milestone.user_id }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
