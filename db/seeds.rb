...
user5.password_confirmation = '123123'
user5.minning_society_name =''
user5.minning_society_rut =''
user5.first_name ='platon5'
user5.last_name ='bacca5'
user5.surname ='bacca5'
user5.rut        ='172993003-5'
#user5.birthdate  =''
#user5.gender_id  =''
user5.civil_status_type_id ='1'
user5.address    = 'osvaldo castillo 1359'
user5.village    ='cona'
#user5.mobile     =''
#use55.landline   =''
user5.region_id  ='1'
...
user6.password = '123123'
user6.password_confirmation = '123123'
user6.minning_society_name =''
user6.minning_society_rut =''
user6.first_name ='platon5'
user6.last_name ='bacca5'
user6.surname ='bacca5'
user6.rut        ='172993003-5'
#user6.birthdate  =''
#user6.gender_id  =''
user6.civil_status_type_id ='1'
user6.address    = 'osvaldo castillo 1359'
user6.village    ='cona'
#user6.mobile     =''
#user6.landline   =''
user6.region_id  ='1'
